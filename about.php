      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/quienesSomos.jpg" alt="Image placeholder" class="img-fluid rounded">
          ...
          <div class="col-md-5">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black">Como Empezó Todo</h2>
            </div>
        ...
        <div class="row">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/brian.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Brian</h3>
                  <p class="block-38-subheading">Papá Chido</p>
                </div>
          ...
          <div class="col-md-8 col-lg-6">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/aylu.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Aylen</h3>
                  <p class="block-38-subheading">Mamá Chida</p>
                </div>
                <div class="block-38-body">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
                </div>
